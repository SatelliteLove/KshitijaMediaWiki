data "aws_availability_zones" "data_availzones" {
...
resource "aws_subnet" "mw_sub_public_a" {
  vpc_id = "${aws_vpc.mw_vpc.id}"
  availability_zone = "${data.aws_availability_zones.data_availzones.names[0]}"
...
resource "aws_subnet" "mw_sub_public_b" {
  vpc_id = "${aws_vpc.mw_vpc.id}"
  availability_zone = "${data.aws_availability_zones.data_availzones.names[1]}"
